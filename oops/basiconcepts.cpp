...
class student
{           // created a class named student which will hold diff types of attributes
...
public:     // made all the attributes public so that they can be accesed from outside
    ...
    // student(int i, string n, int a, int g){ // made a constructor which will set all values in 1 go   
    // before using it comment out all the code in main function
    //     id = i;
    //     name = n;
    //     age = a;
    //     gender =g;
    ...
    void SetId(int i)
    { // created a function to set id we can set it outside by calling the function
        id = i;
    }

    int GetId()
    { // created a function to print id from outside by a function as it is private
        cout << "id : " << endl;
        return id;
    }

    void PrintInfo()
    { // created a function insidea class to print all the values
        cout << "Id : " << id << endl;
        cout << "Name : " << name << endl;
        cout << "Age : " << age << endl;
